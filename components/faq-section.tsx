        ...
        <div className="mx-auto mt-12 flex max-w-xl flex-col gap-6">
          {faqs.map((faq, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ scale: 1.02, borderColor: "rgba(203, 213, 225, 0.3)" }}
              whileTap={{ scale: 0.98 }}
              ...
              <div className="flex items-start justify-between">
                ...
                >
                  {openItems.includes(index) ? (
                    ...
                    <Minus className="text-[#cbd5e1] flex-shrink-0 transition duration-300" size={24} />
                  ) : (
                    <Plus className="text-[#cbd5e1] flex-shrink-0 transition duration-300" size={24} />
                  )}
                </motion.div>
              </div>
              <AnimatePresence>
