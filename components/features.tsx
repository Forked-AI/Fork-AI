      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-8">
          ...
          <p className="text-white/60 text-lg leading-relaxed">
            Most AI chats trap you in a single, messy thread. You lose track of experiments, you cannot safely share
            context, and switching models means starting over. Fork AI fixes this by treating each idea as a branch you
            can grow, prune, and share.
          </p>
        </div>
        <FollowerPointerCard
          title={
            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-2xl leading-none font-semibold tracking-tight">Fork Branching UI</h3>
                  </div>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Fork your chat, not your brain. Drag and drop to fork off alternatives, compare responses
                      side-by-side, and keep your main line of thought clean.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="relative w-full h-[300px] flex items-center justify-center">
                    <svg width="300" height="280" viewBox="0 0 300 280" className="opacity-80">
                      ...
                      <motion.path
                        ...
                        animate={isCliHovering ? { pathLength: 1 } : { pathLength: 0.5 }}
                    ...
                    <motion.div
                      ...
                      animate={isCliHovering ? { scale: [1, 1.3, 1] } : { scale: 1 }}
                      transition={{ duration: 0.5, delay: 0.2 }}
                    />
                  </div>
                </div>
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Drag-and-drop branching</span>
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Visual tree view</span>
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Focus mode</span>
                </div>
              </motion.div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-2xl leading-none font-semibold tracking-tight">Privacy-First Sharing</h3>
                  </div>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Share only what matters. Instead of dumping your entire chat, share a precise slice: a branch, a
                      set of messages, or a summary.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="relative">
                    ...
                    >
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-sm text-white/80">Shared Branch</span>
                      </div>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Unique share links</span>
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Redact sensitive info</span>
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Shareable summaries</span>
                </div>
              </motion.div>
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-2xl leading-none font-semibold tracking-tight">Swap Models Mid-Flow</h3>
                  </div>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Different models are good at different things. Switch models on any branch or compare responses
                      from multiple models on the same context.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                    ...
                    {["GPT-4", "Claude", "Gemini"].map((model, index) => (
                      <motion.div
                        ...
                        animate={
                          isFeature3Hovering
                            ? {
                                y: [0, -10, 0],
                                borderColor: index === 1 ? "rgba(203, 213, 225, 0.6)" : "rgba(255, 255, 255, 0.2)",
                              }
                            : { y: 0 }
                        }
                      ...
                      >
                        ...
                        <div className="text-xs text-white/50 mt-1">
                          {index === 0 ? "Reasoning" : index === 1 ? "Creative" : "Fast"}
                        </div>
                      </motion.div>
                    ))}
                  </div>
                  <motion.div
                    ...
                    animate={isFeature3Hovering ? { opacity: [0, 1] } : { opacity: 0 }}
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Instant switching</span>
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Compare responses</span>
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Keep history</span>
                </div>
              </motion.div>
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Fork AI is built to be accessible. An ad-backed model helps keep usage affordable while we invest
                      heavily in UX and performance.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                  <div className="text-center">
                    ...
                    <div className="mt-6 flex flex-col gap-2 text-left">
                      {["Thoughtful, minimal ads", "Speed & clarity focused", "Built for power users"].map(
                        (item, i) => (
                          <motion.div
                            key={item}
                            className="flex items-center gap-2 text-sm text-white/80"
                            animate={isFeature4Hovering ? { x: [0, 5, 0] } : { x: 0 }}
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Researchers</span>
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Builders</span>
                  <span className="px-3 py-1 rounded-full glass text-xs text-white/80">Power users</span>
                </div>
              </motion.div>
            </div>
          </div>
