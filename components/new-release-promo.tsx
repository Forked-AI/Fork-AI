      ...
      <div className="mx-auto max-w-4xl rounded-[40px] border border-white/10 p-2 shadow-xl backdrop-blur-sm bg-white/5">
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-white/10 glass p-2 shadow-2xl">
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 60% 40% at 50% 50%, rgba(226, 232, 240, 0.08), transparent 70%)",
            }}
          />
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold mb-6 text-white">Fork your AI, fork everything</h2>
              <p className="mb-8 text-lg text-white/90">The best AI UX you have ever experienced.</p>
              <p className="text-white/60 mb-6">Join early users shaping the future of multi-AI workflows.</p>
