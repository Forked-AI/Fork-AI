	...
	return (
		...
		>
            ...
            pointer-events-none
						absolute -inset-[10px]`,
						reducedEffects
							? 'opacity-35 will-change-auto'
							: 'filter blur-[10px] after:animate-aurora after:[background-attachment:fixed] after:mix-blend-difference opacity-50 will-change-transform',
