	...
	return (
		<div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-8 sm:px-6">
			<div className="flex items-center justify-between">
				<div>
					<h1 className="text-2xl font-bold bg-gradient-to-r from-white via-white to-white/60 bg-clip-text text-transparent">Billing & Plan</h1>
        ...
        <div className="relative z-10">
          <div className="mb-6 flex items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-2xl font-bold capitalize text-white">{status.tier}</p>
            </div>
            {status.tier === "trial" ? (
          ...
          <div className="bg-white/[0.02] border border-white/5 rounded-xl p-4">
            <div className="mb-3 flex items-center justify-between text-sm">
              ...
              <span className="font-semibold text-white/90">{usageLabel(status.usagePercent)}</span>
            </div>
            ...
            <p className="mt-3 text-xs text-white/40">
              This meter hides raw token counts while tracking your current plan usage.
            </p>
          </div>
        </div>
			</div>
			...
			<div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-6 shadow-xl relative overflow-hidden">
				<div className="relative z-10">
					...
					<PricingCards currentTier={status.tier} />
				</div>
			</div>
			...
			<div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-6 shadow-xl relative overflow-hidden">
				<div className="relative z-10">
					<div className="mb-6">
						<h2 className="text-lg font-semibold text-white">Subscribe or Manage</h2>
						<p className="mt-1 text-sm text-white/60">
							Start Pro or manage your current subscription in Stripe.
						</p>
					</div>
					<BillingActions tier={status.tier} />
				</div>
			</div>
		</div>
	);
